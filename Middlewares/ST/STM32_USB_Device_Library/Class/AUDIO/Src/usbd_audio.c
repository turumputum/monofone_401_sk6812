...
/** @defgroup USBD_AUDIO_Private_FunctionPrototypes
  ...
  */
extern int playing;
extern uint8_t USBD_HID_Init(USBD_HandleTypeDef *pdev, uint8_t cfgidx);
extern uint8_t USBD_HID_DeInit(USBD_HandleTypeDef *pdev, uint8_t cfgidx);
extern uint8_t USBD_HID_Setup(USBD_HandleTypeDef *pdev, USBD_SetupReqTypedef *req);
